...
func Routers() *gin.Engine {
	...
	PublicGroup := Router.Group("")
	{
		...
		router.InitMessageRouter(PublicGroup) //留言板
	}
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitExcelRouter(PrivateGroup)
		// Code generated by gin-vue-admin Begin; DO NOT EDIT.
		router.InitQuestionRouter(PrivateGroup)
		router.InitQuestion_typeRouter(PrivateGroup)
		router.InitExam_paperRouter(PrivateGroup)
		router.InitBranch_officeRouter(PrivateGroup)
		router.InitQuestion_optionsRouter(PrivateGroup)
		router.InitUser_paper_answerRouter(PrivateGroup)
		router.InitAnswer_questionRouter(PrivateGroup)
		router.InitAttachmentRouter(PrivateGroup)
		//router.InitWx_userRouter(PrivateGroup)
		// Code generated by gin-vue-admin End; DO NOT EDIT.
	}
	AppGroup := Router.Group("")
	// todo:加前台jwt认证
	{
		router.InitAppRouter(AppGroup) //题目
		router.InitWx_userRouter(AppGroup) //wx_user
	}
